...
const JOB_SELECT = "id, customer_id, status, completed_at, created_at, updated_at";
...
export default async function handler(req, res) {
  ...
  const sameDayAnchorBridge = hasSameDayBridgeForAnchor(sessionRows, anchorJobId, now);
