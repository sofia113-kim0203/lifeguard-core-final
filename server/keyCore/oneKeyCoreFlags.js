 ...
 * Env combinations (DIRECT=off / ALLOW_LEGACY=1) must NOT reopen SalesDirector/keySpeak.
 * Legacy escape hatch removed (ROOT_07).
 */
...
/** KEY Master Preview — all Core events + S1 on. Preview-only S7 shadow. */
