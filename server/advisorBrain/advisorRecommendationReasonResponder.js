...
const RECOMMENDATION_REASON_SYSTEM_RULES = [
  ...
  "Use only these evidence fields: recommendation_rank, recommendation_score, reason_codes, uw_flags, budget_band, coverage_gap_level/coverage_label.",
