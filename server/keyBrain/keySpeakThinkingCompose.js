...
function buildS4GoalSpeakText({
  ...
  switch (customerGoal) {
    ...
    case "direction_choice":
      ...
      return `보험 확인했어요. ${insurerProduct}이에요. "그냥 추천"이시면 보통 두 갈래예요—지금 보험료를 줄이고 싶으신 건지, 빠진 보장을 채우고 싶으신 건지. 현재 확인된 필요와 공공 상품 근거가 있으면 회사·상품 후보까지 비교할 수 있어요. 보험료 쪽이 먼저면 지금 실손 한 건 기준으로 볼 여지부터, 보장 쪽이 먼저면 어느 축이 비어 있는지부터 짚는 게 맞아요. 어느 쪽이 더 끌리시는지 알려주시면 그다음 방향을 짧게 정리해 드릴게요.`;
