...
export async function handleHomeBrainFactRequest({
  ...
  const coreResult = await runOneKeyCoreTurn({
    ...
    attachmentReferenceEnabled: isPresenceTurn ? false : attachmentReferenceEnabled,
    activeAttachmentIds: isPresenceTurn ? [] : activeAttachmentIds,
    currentTurnDocumentIds: isPresenceTurn ? [] : currentTurnDocumentIds,
    explicitReopenDocumentIds: isPresenceTurn ? [] : explicitReopenDocumentIds,
    sessionId,
